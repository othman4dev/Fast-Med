      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="caption header-text">
            <h6>SEO ONLINE PHARMACIE</h6>
            <div class="line-dec"></div>
            <h4>Empowering Wellness:<em> Unveiling Beauty in Every Dose </em>for a Healthier <span>Tomorrow.</span></h4>
            <p>FastMed: Beauty and Health Unite. Your go-to for elegant, swift, and reliable online pharmacy solutions.<a href="index.html">Home</a>, <a href="about.html">About</a>, and <a href="faqs.html">FAQ</a>.</p>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="user/assets/images/services-01.jpg" alt="discover SEO" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="user/assets/images/services-02.jpg" alt="data analysis" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="user/assets/images/services-03.jpg" alt="precise data" class="templatemo-feature">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="service-item">
                <div class="icon">
                  <img src="user/assets/images/services-04.jpg" alt="SEO marketing" class="templatemo-feature">
                </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="left-image">
                  <img src="user/assets/images/left-infos.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="section-heading">
